function [] = makePGSE(this, bfactor, G_peak, slewrate)
%MAKEPGSE Summary of this function goes here
%   Detailed explanation goes here

alpha90 = 0.001132; % half the RF gradient plus short reverse gradient
alpha180 = 0.003341; % whole duration of 180 pulse
alphaEcho = 0.012141 / 2 + 0.000299; % half of readout time plus little pause before

epsilon = G_peak/slewrate;

maxTE = 100e-3; % limited by T2
...
DELTA_values = minTE:0.1e-3:maxTE;
...
%TODO: refine delta around where it was low?
...
bfactor_old = bfactor;
bfactor = (this.gamma*abs(G_peak))^2 * (delta2^2*(DELTA-delta2/3) + epsilon^3/30 - delta2*epsilon^2/6);
